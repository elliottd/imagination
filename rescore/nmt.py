...
def init_params(options):
    ...
    params = get_layer(options['decoder'])[0](options, params,
                                              ...
                                              dimctx=ctxdim)
    # readout
    params = get_layer('ff')[0](options, params, prefix='ff_logit_hid',
...
def build_model(tparams, options):
    ...
    logit_lstm = get_layer('ff')[1](tparams, proj_h, options,
                                    prefix='ff_logit_hid', activ='linear')
...
def train(dim_word=100,  # word vector dimensionality
          ...
          dictionaries=[
              '/data/lisatmp3/chokyun/europarl/europarl-v7.fr-en.en.tok.pickle',
              '/data/lisatmp3/chokyun/europarl/europarl-v7.fr-en.fr.tok.pickle'],
          use_dropout=False,
          reload_=False):
    ...
    if reload_ and os.path.exists(saveto):
        with open('%s.pickle' % saveto, 'rb') as f:
    ...
    for eidx in range(max_epochs):
        ...
        for x, y in train:
            ...
            if numpy.mod(uidx, saveFreq) == 0:
                ...
                pkl.dump(model_options, open('%s.pickle' % saveto, 'wb'))
                print('Done')
